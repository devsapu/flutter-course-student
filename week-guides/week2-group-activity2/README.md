...
| Group   | Task file           | Feature              | Branch name                 |
|---------|---------------------|----------------------|-----------------------------|
...
1. Assign each group the corresponding **week2-group-X.md** file.
2. Groups create their branch (e.g. `feature/student-registration`), implement the feature, commit, push, and open a PR.
3. Target branch for PRs: `week-2` or `main` (as set by your repo).
